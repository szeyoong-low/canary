...
async def load_asset_price_daily_qp(
    http_client: AsyncClient,
    symbol: str,
    query_params: QueryParams,
) -> LazyFrame:
    """Data is sorted earliest to latest. Taking Starlette query params."""
...
async def load_market_composition_qp(
    http_client: AsyncClient,
    query_params: QueryParams,
) -> LazyFrame:
    """Data is sorted in descending order of market capitalisation. Taking Starlette query params."""
